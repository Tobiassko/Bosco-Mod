...
public class BoscoAnimations {
    //public static final Animation BOSCO_IDLE = Animation.Builder.create(3.0F).looping()
    ...
    //              new Keyframe(1.5F, AnimationHelper.createRotationalVector(0.0F, 0.0F, -4.0F), Transformation.Interpolations.LINEAR),
    //              new Keyframe(3.0F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 4.0F), Transformation.Interpolations.LINEAR)
    //      ))
    ...
    //      ))
    //      .build();
    public static final Animation BOSCO_ATTACK = Animation.Builder.create(0.75F)
            .addBoneAnimation("Arm_Right", new Transformation(Transformation.Targets.ROTATE,
                    new Keyframe(0.0F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
